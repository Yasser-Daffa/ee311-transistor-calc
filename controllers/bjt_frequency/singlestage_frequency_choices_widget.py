...
from controllers.bjt_frequency.ce_low_high_frequency_widget import CELowHighFrequencyWidget
from controllers.bjt_frequency.cc_low_high_frequency_widget import CCLowHighFrequencyWidget
...
class SingleStageFrequencyChoicesWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        for button in [self.buttonCE, self.buttonCC, self.buttonDirectRpi, self.buttonDirectLowFreq]:
    ...
    def connect_signals(self):
        ...
        self.buttonDirectLowFreq.clicked.connect(lambda: self.show_page(3))
